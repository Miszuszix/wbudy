...
C_DEPS += \
./src/light_sensor/light_sensor.d 

OBJS += \
./src/light_sensor/light_sensor.o 


# Each subdirectory must supply rules for building sources it contributes
src/light_sensor/%.o: ../src/light_sensor/%.c src/light_sensor/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-light_sensor

clean-src-2f-light_sensor:
	-$(RM) ./src/light_sensor/light_sensor.d ./src/light_sensor/light_sensor.o

.PHONY: clean-src-2f-light_sensor
